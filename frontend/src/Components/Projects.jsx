...
import TableHead from '@mui/material/TableHead';
import TableRow from '@mui/material/TableRow';
import { TablePagination, Grid, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material';
import { blue } from '@mui/material/colors';
  ...
  return (
    <ThemeProvider theme={customTheme}>
      <Box sx={{ textAlign: 'center' }}>
        ...
        {/* Table */}
        <TableContainer component={Paper} sx={{ width: '100%', maxWidth: '80%', margin: 'auto', mt: 4 }}>
          <Table>
            {/* Table Header */}
            <TableHead>
              <TableRow>
